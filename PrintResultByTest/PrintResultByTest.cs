...
namespace PrintResultByTest
{

    [ComVisible(true)]
    [ProgId("PrintResultByTest.PrintResultByTest")]

    public class PrintResultByTest : IWorkflowExtension, IEntityExtension
    {
        ...
        public void Execute(ref LSExtensionParameters Parameters)
        {
            try
            {
                ...
                if (reportStation != null)
                {
                    ...
                    Test fathertest = res.Test;
                    var sampleName = test.Aliquot.Sample.Name;
                    var testcode = "";
                    testcode = fathertest.DESCRIPTION;
